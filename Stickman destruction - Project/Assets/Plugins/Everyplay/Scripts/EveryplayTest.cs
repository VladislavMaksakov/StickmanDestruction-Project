...
public class EveryplayTest : MonoBehaviour
{
    ...
    private UnityEngine.UI.Text uploadStatusLabel;
    ...
    {
        GameObject uploadStatusLabelObj = new GameObject("UploadStatus", typeof(UnityEngine.UI.Text));

        if (uploadStatusLabelObj)
        {
            uploadStatusLabelObj.transform.parent = transform;
            uploadStatusLabel = uploadStatusLabelObj.GetComponent<UnityEngine.UI.Text>();
